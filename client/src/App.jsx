  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<PrivateRoute><Layout /></PrivateRoute>}>
        ...
        <Route path="products/add" element={<PrivateRoute roles={['admin']}><Inventory /></PrivateRoute>} />
        <Route path="products/sell" element={<PrivateRoute roles={['admin', 'staff']}><SellProducts /></PrivateRoute>} />
        ...
        <Route path="inventory" element={<Navigate to="/products/add" replace />} />
      </Route>
